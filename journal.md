...
x RL/PG (8h)
x RL/DDPG (6h)
x Exp/Exploration/Action noise: Add formulae and reasoning (2h)
x Exp/Exploration/Random exploration: Add formulae, more detail (2h)
x Exp/Exploration/Parameter noise: More detail (1h)
x Exp/VanGrad/Simple architecture: More detail, cross reference to complexities from other papers (1h)
x Exp/VanGrad/Norm: Cross-references to other norm papers (30m)
x Exp/ActGrad/GradAct: Add formulae, more detail (1.5h)
x Exp/ActGrad/FeedPast: Add formulae (1h)
x Exp/ActGrad/Clip: Add formulae (1h)
x Exp/Nonsense/PER: Write (4h)
x Exp/Nonsense/Data aug: Add details (30m)
...
I feared a bug around the handling of death conditions where a negative Q(s', a') would have it prefer dying than not, and in fact it is dying quite often...