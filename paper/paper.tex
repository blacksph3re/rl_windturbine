...
As PID controllers have proven well in controlling a turbine and neural nets directly performed poorly, we could imagine to predict PID controller parameters instead of directly building the controller. \cite{kolterDesignAnalysisLearning2012} had successes with this approach, and maybe using a more advanced algorithm such as DDPG would result in even better performance.
